...
public class SiteDto {
    ...
    public SiteDto(String id, String name, String sale_fees_mode, String default_currency_id, Integer mercadopago_version, String immediate_payment, List<String> payment_method_ids) {
        this.id = id;
        this.name = name;
